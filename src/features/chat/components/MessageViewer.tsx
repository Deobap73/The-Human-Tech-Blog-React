        ...
        return (
          ...
          >
            <div className="chat-message__bubble">
              <div className="chat-message__content" dangerouslySetInnerHTML={{ __html: contentHTML }} />
              <span className="chat-message__meta">
                {isSelf ? t('chat.messagelist.you', 'You') : (typeof msg.sender === 'object' && 'name' in msg.sender ? msg.sender.name : 'User')}
                {' • '}
                {time}
              </span>
            </div>
